...
def main():
    ...
    for x in range(0, 10):
        ...
        bits_errors = gilbert_model(bits_coded)    #zapis błędów
        bits_decoded = bsc.rehamminging(bits_errors) #odczytywanie kodu z wykrywaniem błędów i usuwaniem bitów parzystości
