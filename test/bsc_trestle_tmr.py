...
def main():
    ...
    for x in range(0, 10):
        ...
        bits_TMR_errors = bsc.generateErrors(bits_trestle, fault_prob)  # generowanie błędów na potrojonych bitach
        bits_detrestle = bsc.decodeTrestle(bits_TMR_errors)
        decoded_bits = decodeTMR(bits_detrestle)         # odczyt i dekodowanie potrojonych bitów z błędami
